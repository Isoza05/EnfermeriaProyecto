...
public partial class EnfermeriaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__enf_cita__3213E83F291A59E2");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__enf_hora__3213E83F43D9B924");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__enf_pers__3213E83F7A620EE1");

            entity.ToTable("enf_personas");

            entity.HasIndex(e => e.Cedula, "UQ__enf_pers__415B7BE5EB3036A5").IsUnique();

            entity.HasIndex(e => e.Usuario, "UQ__enf_pers__9AFF8FC6B6CB96C9").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__enf_pers__AB6E61642786EE93").IsUnique();
